...
def main(input_filename):
    ...
    spec_width = 10e-3
    spec_thickness = 4e-3
    Strain_tot = -P_tot/(40) # dx/x
    # Strain_tot = -P/(40) # dx/x
    ...
    # Stress_tot = F/((spec_width*spec_thickness)*(-Strain_tot*possion_ratio+1)*(-Strain_tot*possion_ratio+1)) # force/cross-sectional-area
